...
const props = defineProps({ api: { type: Object, default: () => ({}) }, initialConfig: { type: Object, default: () => ({}) }, config: { type: Object, default: () => ({}) }, version: { type: String, default: '2.1.22' }, defaultTab: { type: String, default: 'dashboard' } })
...
const version = computed(() => props.version || '2.1.22')
