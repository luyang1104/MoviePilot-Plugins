...
from .payloads import DeleteRequest, apply_path_mapping, as_media_type, is_excluded_path
...
class SyncDeleter:
    ...
    @staticmethod
    def _remove_parent_dir(file_path: Path):
        """删除父目录：父路径下无媒体文件时逐级回收空目录（最多上溯三级，不碰根目录）。"""
